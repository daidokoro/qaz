...
type Config struct {
	...
	Stacks            map[string]struct {
		...
		Troposphere      bool                   `yaml:"troposphere,omitempty" json:"troposphere,omitempty" hcl:"troposphere,omitempty"`
		TroposphereImage string                 `yaml:"troposphere_image,omitempty" json:"troposphere_image,omitempty" hcl:"troposphere_image,omitempty"`
